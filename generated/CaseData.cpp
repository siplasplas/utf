...
#include "utf/UnicodeData.hpp"

namespace utf::data {

// Simple toLower mapping: uppercase code point -> lowercase code point
const std::pair<char32_t, char32_t> lower_map[] = {
    {0x0041, 0x0061},
    {0x0042, 0x0062},
    {0x0043, 0x0063},
    {0x0044, 0x0064},
...
const size_t lower_map_size = 1488;

// Simple toUpper mapping: lowercase code point -> uppercase code point
const std::pair<char32_t, char32_t> upper_map[] = {
    {0x0061, 0x0041},
    {0x0062, 0x0042},
    {0x0063, 0x0043},
    {0x0064, 0x0044},
...
const size_t upper_map_size = 1505;

// Special toUpper mapping (1:N), e.g., ß -> SS
const SpecialCase special_upper[] = {
    {0x00DF, {0x0053, 0x0053, 0x0000}, 2},
    {0x0149, {0x02BC, 0x004E, 0x0000}, 2},
    {0x01F0, {0x004A, 0x030C, 0x0000}, 2},
    {0x0390, {0x0399, 0x0308, 0x0301}, 3},
    {0x03B0, {0x03A5, 0x0308, 0x0301}, 3},
    {0x0587, {0x0535, 0x0552, 0x0000}, 2},
    {0x1E96, {0x0048, 0x0331, 0x0000}, 2},
    {0x1E97, {0x0054, 0x0308, 0x0000}, 2},
    {0x1E98, {0x0057, 0x030A, 0x0000}, 2},
    {0x1E99, {0x0059, 0x030A, 0x0000}, 2},
    {0x1E9A, {0x0041, 0x02BE, 0x0000}, 2},
    ...
    {0xFB00, {0x0046, 0x0046, 0x0000}, 2},
    {0xFB01, {0x0046, 0x0049, 0x0000}, 2},
    {0xFB02, {0x0046, 0x004C, 0x0000}, 2},
    {0xFB03, {0x0046, 0x0046, 0x0049}, 3},
    {0xFB04, {0x0046, 0x0046, 0x004C}, 3},
    {0xFB05, {0x0053, 0x0054, 0x0000}, 2},
    {0xFB06, {0x0053, 0x0054, 0x0000}, 2},
    {0xFB13, {0x0544, 0x0546, 0x0000}, 2},
    {0xFB14, {0x0544, 0x0535, 0x0000}, 2},
    {0xFB15, {0x0544, 0x053B, 0x0000}, 2},
    {0xFB16, {0x054E, 0x0546, 0x0000}, 2},
    {0xFB17, {0x0544, 0x053D, 0x0000}, 2},
};
const size_t special_upper_size = 102;

const SpecialCase special_lower[] = {
    {0x0130, {0x0069, 0x0307, 0x0000}, 2},
};
const size_t special_lower_size = 1;
